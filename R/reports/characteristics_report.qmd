...
print(total_items)
```
Note that n_number is the number of distinct item levels across studies. I.e, we across studies, we have 111 different collection of items in terms of how many were used in the recognition test. 
## Post event retention(in hours)
```{r}
postev_ret <- df %>% 
