...
sd(control$tp_recall[control$tp_correct == 1])

#tp correction
mean(control$tp_recall[control$tp_correct == 2])
sd(control$tp_recall[control$tp_correct == 2])
...
sd(control$spider_recall[control$spider_correct == 1])

# spider correction
mean(control$spider_recall[control$spider_correct == 2])
sd(control$spider_recall[control$spider_correct == 2])
